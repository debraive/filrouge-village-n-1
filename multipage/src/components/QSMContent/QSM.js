    ...
    render() {
        return (
            <div>
                ...
                <h3>Nos Activités</h3>
                <ul>
                    <li><h4>Activités industrielles:</h4> assemblage, emballage, étiquetage</li>
                    <li><h4>Back Office Services:</h4> archivage, call-center, scanning</li>
                    <li><h4>Cleaning:</h4> nettoyage professionnel de bureaux, salles de sports, immeubles, etc</li>
                    <li><h4>Horticulture:</h4> entreprises et particuliers</li>
                    <li><h4>Rénovation :</h4> électricité, plomberie, peinture, etc.</li>
                    <li><h4>Activités titres-services:</h4> aide au ménage, repassage</li>
                </ul>
                <h3>Quelques chiffres</h3>
                <h4>Les acteurs</h4>
                <ul>
                  <li>Plus de 600 travailleurs</li>
                  <li>Personnel awiph : 60%</li>
                  <li>Personnel insertion : 12%</li>
                </ul>
                <h4>Les infrastructures</h4>
                <ul>
                  <li>1 entreprise de travail adapté : ETA</li>
                  <li>3 sociétés à finalité sociale : B-Team, ADM, Proxi</li>
                  <li>2 Sites géographiques propres à Braine-l'Alleud et Wauthier-Braine</li>
                  <li>plus de 10 sites clients</li>
                </ul>
                <h4>Les résultats financiers 2015</h4>
                <ul>
                  <li>Chiffres d'affaires plus de 10.000.000€</li>
                  <li>Effectif moyen : 750 ETP</li>
                </ul>
            </div>
        )
    }
